                  ...
                  {data &&
                    ...
                    data.map((item: any) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell>{item.emit}</TableCell>
                        <TableCell>{formatCurrency(item.taxesTotal)}</TableCell>
                        <TableCell>
                          {formatCurrency(item.details.ICMS)}
                        </TableCell>
                        <TableCell>
                          {formatCurrency(item.details.IPI)}
                        </TableCell>
                        <TableCell>
                          {formatCurrency(item.details.PIS)}
                        </TableCell>
                        <TableCell>
                          {formatCurrency(item.details.COFINS)}
                        </TableCell>
                      </TableRow>
                    ))}
                </TableBody>
